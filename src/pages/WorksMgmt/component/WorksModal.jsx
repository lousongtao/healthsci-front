  ...
  const buildForm = () => {
    return (
      <Form
        ...
        <Form.Item
          name="mediaPlayDate"
          extra='首次刊播于2022年内的作品'
          rules={[{required: true,message: '请输入首次刊播/刊登/出版时间'}]}
          label="首次刊播/刊登/出版时间">
          <DatePicker
            disabledDate={date => date.isAfter('2023-01-01') || date.isBefore('2022-01-01')}
            placeholder="刊播时间"/>
        </Form.Item>
        <Form.Item
          name="mediaPlayTimes"
        ...
        <Card title="申报项目情况" bordered={false} style={{ width: '100%' }}>
          <Form.Item name="projectBrief" label="项目综述" labelCol={4} wrapperCol={20}
            ...
            <Input.TextArea
              ...
              rows={6}
              maxLength={500}
              placeholder="请高度概括申报作品的内容、亮点特色及社会影响等"
          ...
          <Form.Item name="projectDesc" label="项目介绍" labelCol={4} wrapperCol={20}
            ...
            <Input.TextArea
              ...
              rows={14}
              maxLength={2000}
              placeholder="请详细介绍科普作品介绍，成果实施、应用和普及情况，产生的社会效益及贡献等"
              disabled={props.viewMode} />
          </Form.Item>
        </Card>
